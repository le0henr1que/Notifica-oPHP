...
<head>
    ...
    <title>(<?php echo $linha2;?>) - Area 2</title>
...
<form method="POST">
    ...
    if(isset($_POST["enviar"])){
        ...
        if($destino_ != $_SESSION['area']){
            if($destino_ == "area1")
            {
                $querym = "INSERT INTO notifica_area1 (nome_env, assunto) values ('$enviado','$assunto_')";
    ...
    ?>
    <p>Destino é quem vai receber a notificação, destino = "area1"
</body>
</html>